...
export default function HRWorkspace() {
  ...
  // Get category from localStorage or URL params
  ...
  // Redirect non-HR users away from this page
  if (!isLoading && user?.role !== 'hr') {
    return null;
  }

  const { data: leads, isLoading: leadsLoading } = useQuery({
    queryKey: ["/api/leads/by-category", selectedCategory],
    retry: false,
  });
      ...
      <main className="flex-1 overflow-auto">
        <div className="p-8 space-y-6">
          ...
          <div className="bg-gradient-to-r from-green-50 to-cyan-50 dark:from-green-950 dark:to-cyan-950 rounded-lg p-6 shadow-sm border border-green-200 dark:border-green-800">
            ...
            <p className="text-gray-600 dark:text-gray-400">Select a hiring category to view assigned leads</p>
          </div>

          {/* Category Selector */}
          <Card className="shadow-lg border-0">
            <CardHeader className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-950 dark:to-indigo-950 border-b">
              <CardTitle className="text-blue-700 dark:text-blue-300">Select Hiring Category</CardTitle>
            </CardHeader>
          ...
          <Card className="shadow-lg border-0">
            <CardHeader className="bg-gradient-to-r from-green-50 to-cyan-50 dark:from-green-950 dark:to-cyan-950 border-b">
              <CardTitle className="text-green-700 dark:text-green-300">Leads - {selectedCategory}</CardTitle>
            </CardHeader>
            <CardContent className="p-6">
              {leadsLoading ? (
